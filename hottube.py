...
INIT_FOAM        = 900
INIT_NEUTRINO    = 100
FOAM_RADIAL      = 2.5    # Basis radial-inward Geschwindigkeit
FOAM_TANG        = 3.0    # Tangentiale Geschwindigkeit
FOAM_GRAVITY     = 0.05   # Gravitationsbeschleunigungskonstante

NEUTRINO_SPEED   = 3.0    # Konstante Geschwindigkeit
NEUTRINO_JIT     = 0.2    # Jitter
NEUTRINO_PULL    = 0.1    # Leichte Anziehung zum Zentrum
...
while running:
    ...
    for p in particles:
        ...
        if p.type == "foam":
            ...
            if r <= DRAIN_RADIUS:
          #      global foam_count  # Entferne diesen Verweis, da er nicht nötig ist
                foam_count += 1
